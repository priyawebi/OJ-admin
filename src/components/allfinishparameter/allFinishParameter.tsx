...
function AllFinishParameter() {
  ...
  //get all finish parameters list
  useEffect(() => {
    axios
      .get(`${url}api/admin/finishparameters/all`, {
          ...
          <div className="flex-style">
            <Breadcrumbs separator="›" aria-label="breadcrumb">
              ...
              <Typography color="textPrimary">
                <h3 className="breadcumbs">Finish Parameter</h3>
              </Typography>
            </Breadcrumbs>
            <PageHead
              setOpen={setOpen}
          ...
          <Table className="gem-family">
            <thead>
              <tr>
                ...
                <th className="col-sm-8 align-item-right"> </th>
              </tr>
            </thead>
            {data?.map((dt) => {
              return (
                <Link
                  href={`/finish-parameters?id=${dt._id}`}
