...
function AllJeweleryType() {
  ...
  const getGemData = (limit: number, page: number) => {
    axios.get(`${url}api/admin/jewellerytype/all`,{headers:{Authorization:`Bearer ${token}`}}).then((res) => setData(res.data));
  };
  return (
    <>
      <Container activeBar={"Jewellery Type"} />
      <div className="main-content">
        ...
        <Typography color="textPrimary" ><h3 className='breadcumbs'>Jewellery Type</h3></Typography>
      </Breadcrumbs>
          <PageHead
...
export default AllJeweleryType;
