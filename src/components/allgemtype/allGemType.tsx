...
function AllGemType() {
  ...
  const getGemData = (limit: number, page: number) => {
    axios.get(`${url}api/admin/gem/type/all`,{headers:{Authorization:`Bearer ${token}`}}).then((res) => setData(res.data));
  };
  return (
    <>
      <Container activeBar={"GemType"} />
      <div className="main-content">
        ...
        <Typography color="textPrimary" ><h3 className='breadcumbs'>GEM Type</h3></Typography>
      </Breadcrumbs>
          <PageHead
            //title="GEM Type"
            //smallCountValue={10}
          ...
          <Table className="gem-family">
            <thead>
              <tr>
                ...
                <th className="col-sm-3">JEWELLERY TYPES</th>
