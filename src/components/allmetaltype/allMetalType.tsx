...
function AllMetalType() {
  ...
  const getGemData = (limit: number, page: number) => {
    axios
      .get(`${url}api/admin/metaltype/all`, {
  ...
  return (
    <>
      <Container activeBar={"Metal Type"} />
      <div className="main-content">
        ...
        <Typography color="textPrimary" ><h3 className='breadcumbs'>Metal Type</h3></Typography>
      </Breadcrumbs>
