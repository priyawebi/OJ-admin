...
function JewelleriesList() {
    ...
    const [keyValue, setKeyValue] = useState({
        ...
        gemstoneVariety: "GEMSTONE VARIETY",
        country: "COUNTRY",
        period: "PERIOD",
    ...
    const clickAction = (data: any) => {
        Router.push("/jewellery-details?id=" + data.id);
    }
    ...
    const getCustomerData = (limit: number, page: number) => {
        fetch(`http://localhost:3000/jewelleries?_limit=${limit}&_page=${page}`)
            .then((res) =>
                res.json())
            .then((response) => {
    ...
    return (
        <>
            <Container activeBar={"jewellery"} />
            <div className='main-content'>
                <div className='m-4'>
                    <PageHead title="Customers" smallCountValue={10} setOpen={setOpen} open={open} FilterButton={true} exportButton={true} addButton={"/add-jewellery"} />
                    <div>
                        <Collapse in={open}>
                            <div id='example-collapse-text'>
                                ...
                                <div className='col-sm-12 row align-items-center mt-4'>
                                    <div className='col-sm-2 d-flex gap-2 align-items-center mb-2'> From
                                        <input type='text' className='form-control' />
                                    </div>
                                    <div className='col-sm-2 d-flex gap-2 align-items-center mb-2'> To
                                        <input type='text' className='form-control' />
                                    </div>
                                    <div className='col-sm-3 d-flex gap-2 align-items-center mb-2'> Jewel type
                                    ...
                                    <div className='col-sm-3 d-flex gap-2 align-items-center mb-2'> Designer
                                        <Form.Select aria-label='Default select example'>
                                            <option>Select</option>
                                            <option value='1'>One</option>
                                            <option value='2'>Two</option>
                                ...
                                <div className='col-sm-12 row align-items-center mb-3 mt-3'>
                                ...
                                <div className='col-sm-12 row align-items-center mb-2'>
                                    ...
                                    <div className='col-sm-3 d-flex gap-2 align-items-center mb-2'> Gemstone variety
                                        <Form.Select aria-label='Default select example'>
                                            <option>Select</option>
                                            <option value='1'>One</option>
                                            <option value='2'>Two</option>
                                    ...
                                    <div className='col-sm-3 d-flex gap-2 align-items-center mb-2'> Country
                                        <Form.Select aria-label='Default select example'>
                                            <option>Select</option>
                                            <option value='1'>One</option>
                                            <option value='2'>Two</option>
                                    ...
                                    <div className='col-sm-2 d-flex gap-2 align-items-center mb-2'> Period
                                        <Form.Select aria-label='Default select example'>
                                            <option>Select</option>
                                            <option value='1'>One</option>
                                            <option value='2'>Two</option>
