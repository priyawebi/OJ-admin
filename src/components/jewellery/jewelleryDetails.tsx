                            ...
                            <Col sm={router.query?.id ? 8 : 12}>
                                <div className='cards'>
                                    ...
                                    <div className='row align-items-center my-3'>
                                        <div className='col-sm-3'>
                                            <p className='label-text'>Date of creation</p>
                                        </div>
                                        <div className='col-sm-9'>
                                    ...
                                    <div>
                                        <p className='label-text mb-3 mx-2'>Size / Quantity</p>

                                        <div className='mx-2 border-box'>
                                            <Table>
                                                <thead>
                                                    <tr>
                                                        <th className='col-sm-5'>SIZE NAME</th>
                                                        <th className='col-sm-5'>QTY</th>
                                    ...
                                    <div>
                                        <div className='row align-items-center my-3'>
                                            ...
                                            <div className='col-sm-3'>
                                                <p className='label-text'>Jewellery for Women</p>
                                            </div>
                                            <div className='col-sm-8'>
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'>Jewellery for Men</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <div className='form-check form-check-inline'>
                                                    <input
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'>Carat weight</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <Form.Control
                                                    className='h-40'
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'>Antique</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <div className='form-check form-check-inline'>
                                                    <input
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'>Period (if anitique)</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <Form.Select
                                                    className='h-40 '
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'> Gem color</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <div>
                                                    <MultiSelect
                                        ...
                                        <div className='row align-items-center my-3'>
                                            <div className='col-sm-3'>
                                                <p className='label-text'> Gem varietes</p>
                                            </div>
                                            <div className='col-sm-8'>
                                                <div>
                                                    <MultiSelect
