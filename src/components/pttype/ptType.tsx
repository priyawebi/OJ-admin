...
function MetalType() {
  ...
  useEffect(() => {
    if (router.query.id) {
      axios
        .get(`${url}api/admin/pttype/${router.query.id}`, {
  ...
  return (
    <>
      ...
      <div className="mt-4 m-4">
        ...
        <Typography color="textPrimary" >
        <Link color="inherit"  href="/all-pt-type" >
          <h3 className='dynamic-breadcumbs'>PT Type</h3>
        </Link>
          </Typography>
        ...
        <Formik
          ...
          onSubmit={(values) => {
            ...
            if (router.query.id === undefined) {
              axios
                .post(`${url}api/admin/pttype`,formData, {
                  headers: {
                ...
                .then((result) => {
                  showToaster("success", "PtType Added Successfully");
                })
                .catch((err) => {
                  showToaster("error", "PtType Not Inserted ");
                });

              Router.push("/all-pt-type");
            } else {
              
              axios
                .put(`${url}api/admin/pttype/${router.query.id}`,formData, {
                  headers: {
                    "Content-Type": "multipart/form-data",
                    Authorization: `Bearer ${token}`,
                  },
                ...
                .then((result) => {
                  showToaster("success", "PtType Update Successfully");
                })
                .catch((err) => {
                  showToaster("error", "PtType Not Update");
                });
            }
            Router.push("/all-pt-type");
          }}
                  ...
                  <div className="cards">
                    <div className="row align-items-center ">
                      <div className="col-sm-3">
                        <h6 className="label-text bold">PT Type</h6>
                      </div>
                    </div>
